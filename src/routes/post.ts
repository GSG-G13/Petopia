...
import { addPost, deletePost, getExplorePosts, getPost, updatePost, getFeedPosts } from '../controllers'
...
postRouter.get('/feed', authUser, checkType([ADMIN, REGULAR]), getFeedPosts)
