import { Button, Card, Avatar, Row, Col, Typography, Space, Badge } from 'antd';
...
const UserProfile = () => {
  ...
  return ( 
    <>
      ...
      <Card style={{ width: "100%", position: 'relative' }} bordered={false}>
      <Button type="link" icon={<LeftOutlined />}>Back</Button>
        ...
        <Col span={12} style={{ textAlign: 'right', position: 'absolute',marginTop:20, right: '40px' }}>
            <Space>
      ...
      <Button type="primary" size={'large'}style={{ borderRadius: "150px",backgroundColor: '#F37F29', fontSize: '16px',width: 130}}>Follow</Button>
            </Space>
          </Col>
          ...
          <Col span={12}>
            <Avatar
              ...
              style={{ marginTop: '-30px',marginLeft:20, border: '2px solid white', zIndex: 1 }}
            />
        ...
        <CalendarAdd style={iconStyle} className="notification" />
            ...
            <Col style={{marginBottom:15}}>
            <Space>
              <Text onClick={showNormalPostModal}><strong>565</strong> Following</Text>
              <Text><strong>565</strong> Followers</Text>
            </Space>
            </Col>
            <Col style={{marginBottom:15}}>
            <Space>
