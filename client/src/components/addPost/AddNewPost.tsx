    ...
    <Space direction="vertical" size={16}>
      ...
      <Card className="card">
        ...
        <Space direction="horizontal" size={16}>
          <Button type="text" size="large" className="discussButton postButtons" onClick={showNormalPostModal}>
            Normal Post
          </Button>
          <Button type="text" size="large" className="adoptionButton postButtons" onClick={showAdoptionModal}>
            Adoption
          </Button>
          <Button type="text" size="large" className="productButton postButtons" onClick={showProductModal}>
            Product
          </Button>
          <Button type="text" size="large" className="helpButton postButtons">
            Help
          </Button>
        </Space>
      </Card>
