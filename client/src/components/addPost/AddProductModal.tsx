import { Modal, Form, Input, InputNumber, Card, Upload } from 'antd';
  ...
  <Form.Item name="dragger" valuePropName="fileList" getValueFromEvent={normFile} noStyle>
    <Upload.Dragger name="files" action="/upload.do" listType="picture" multiple={true}>
      ...
      <p>Click or drag Images to this area to upload</p>
          ...
          <div className='petInformationTitle'>Product Information</div>
          ...
          <Form.Item label="Details">
            <TextArea style={{ height: 90, width: 490 }} placeholder="What's in your product details, Mohammed?" />
          </Form.Item>
        </Card>
      </Form>
    </Modal>
